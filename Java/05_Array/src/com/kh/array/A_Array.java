...
public class A_Array {
	...
	public void method1() {
		...
		System.out.println(nums);    // nums의 주소값이 보임 
	...
	// [강사님]
		...
		for(int i=0; i<arr.length; i++) {
			...
			System.out.printf("%.1f", sum1 / arr.length);
	}
	...
	public void method5() {
		...
		System.out.println(number);
		System.out.println(copy);        // 둘이 주소값도 다르고 
		
		copy[1] = 20;
		
		System.out.println(Arrays.toString(copy));
		System.out.println(Arrays.toString(number));    // 배열 안 숫자도 다름 
	}
