...
/*
	 ...
	 * - 인터페이스는 구현하려면 implements 키워드를 사용한다.
	 ...
	 * - 인터페이스는 interface 키워드로 정의되어 있고 인터페이스 내에 변수, 메서드 생성 불가능 (인터페이스의 변수는 상수, 메서드는 추상)
	 * 
	 * [extends와 implements]
...
public class Application {
	...
	public static void main(String[] args) {
		...
		// Vehicle v = new Vehicle();   <-- 인터페이스는 객체 생성X
		// 참조변수(데이터타입)으로는 명시 가능
		Vehicle bus = new Bus();
