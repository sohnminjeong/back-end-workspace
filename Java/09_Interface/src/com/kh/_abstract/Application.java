...
public class Application {
	...
	public static void main(String[] args) {
		...
		// 상속O -> 상속 받으니 rule의 값이 모두 동일해짐 => 자식에서 rule()을 오버라이딩!
		// Sports s = new Sports(5); -> Sports를 추상 클래스로! 해당 선언 생성 불가!
		// 추상 클래스는 new 객체생성 불가하여 에러 발생!
