...
public class ConditionPractice {
	...
	public void practice4() {
		...
		if(kor >= 40 && eng >= 40 && math>=40 && avg>=60) {
			System.out.println("국어점수 : "+kor+" 수학점수 : "+math+" 영어점수 : "+eng+" 합계 : "+sum+" 평균 : "+avg+" 축하합니다, 합격입니다!");
		} else {
	 ...
	 * 아이디와 비밀번호가 둘 다 틀렸을 시 "로그인 실패" 출력
	 * 
	 ...
	 * 중간 고사 점수(20) : 16.0 기말 고사 점수(30) : 27.0 과제 점수 (30) : 15.0 출석 점수 (20) : 15.0 총점 :
	 * 73.0 PASS
	 * 
	...
	public void practice11() {
		...
		if(sum>=70 && att1 >= 7) {
			System.out.printf("중간 고사 점수(20) : %.1f 기말 고사 점수(30) : %.1f 과제 점수(30) : %.1f 출석 점수 (20) : %.1f 총점 : %.1f PASS", middle1, last1, task1, att2, sum);
