...
AS SELECT * FROM kh.department;   -- create에서 서브쿼리를 실제 쓸 일은 거의 X
...
/*
    ...
    - 기본값 변경 : ALTER TABLE 테이블명 MODICY 컬렴명 자료형 DEFAULT 변경할기본값;
...
-- location_id 컬럼의 자료형은 VARCAHR(2),
